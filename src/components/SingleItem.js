        ...
        >
          <article className="inner-single-item">
            ...
            <div className="single-item-texts">
              <p className="description">{readMore ? state.elItem.description : `${state.elItem.description.substring(0, 20)}${!readMore ? '...' : ''}`}<span className="show-more" onClick={() => setReadMore(!readMore)}>{readMore ? 'show less' : 'read more'}</span></p>
              <section
                className="qty-cont"
              >
