...
const Register = () => {
    ...
    useEffect(() => {
        dispatch({ type: ACTION.VALIDEMAIL, payload: EMAIL_REGEX.test(state.email) })
    }, [state.email])
            ...
            {state.success ? (
                ...
                <section className="reg-cont">
                    ...
                    <form onSubmit={handleSubmit}
                        ...
                        <label htmlFor="email">
                            email:
                            <FontAwesomeIcon icon={faCheck} className={state.validEmail ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={state.validEmail || !state.email ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="email"
